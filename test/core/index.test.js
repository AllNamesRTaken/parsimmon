...
it("index", function () {
  ...
  assert.deepEqual(parser.parse("").value, { offset: 0, line: 1, column: 1 });
  assert.deepEqual(parser.parse("xx").value, { offset: 2, line: 1, column: 3 });
...
it("multiple index", function () {
  ...
  assert.deepEqual(parser.parse("a\nb").value, {
    index1: { column: 1, line: 1, offset: 0 },
    index2: { column: 2, line: 2, offset: 3 },
    str: "a\nb",
  });
});
